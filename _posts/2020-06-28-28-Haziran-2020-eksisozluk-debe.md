...
- entry_name: |
    darwin'in evrim teorisine inananlar
  entry_id:  109430783
  entry_writer: the man who have a plan
  entry_fav_count: 139
  entry_content: |
    "sermayecilerin istediği köleliğe en yakın gruptur." demiş bazı arkadaşlar. <br/><br/>bir bakın bakalım şuan ki dünya düzenini rahatça idare edebilmek için en çok hangi araç kullanılıyor. sizin kapitalizminizi ve düzeninizi devam ettiren en büyük araç dinleriniz. insanlara öteki dünyadaki hayat hikayeleri anlatılarak bu dünyada köleliğe razı ediyorlar.
...
- entry_name: |
    eynesil'de yeni yapılan yola zarar veren kadın
  entry_id:  109423875
  entry_writer: babasini bakkala gonderen cocuk
  entry_fav_count: 130
  entry_content: |
    belediyenin açıklamasına göre kendi evinin önüne beton dökmediler diye yolu kazan teyzedir. bu insanların çıkarcılığı midemi bulandırıyor.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 82
  entry_content: |
    erdoğan’ı bu kadar tepki olan bir dönemde, sınavdan bir gün önce yeni bir şey söylemeyeceği halde gençlerin karşısına çıkarma fikri kiminse kendisini çok takdir ediyor, yeni hayatında başarılar diliyorum.
...
- entry_name: |
    berat albayrak'ın rap performansı
  entry_id:  109432816
  entry_writer: mudavim5824
  entry_fav_count: 27
  entry_content: |
    bok gibi bir ergen çalışması.
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    fenerbahçe, kazandığı korneri çalışılmış bir organizasyonla kullanmak istedi. ama korner atışının devamında paslaşarak kaleci altay'a döndüler.
  entry_channels: spor
- entry_name: |
    erkeğini baştan vs ekmeğini taştan çıkaran kadın
  entry_id:  109439842
  entry_writer: madame tutli putli
  entry_fav_count: 12
  entry_content: |
    çok zor bir ayrım ama ikincisini seçeceğim versustur. çünkü külotlu çorap giymek çok kolay ama sabahın köründe uykularından uyanıp yola koyulmak pek zor. önce iş sonra aşk. <br/>ya sonra?
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    armağan çağlayan twitterda günümüz fenomenleriyle ilgili bunları kim hayatımıza sokuyor diyip yutupda para kazanmak için bu tipleri konuk ediyor. sen zorla sokuyorsun işte götveren.. çocukken pop starda da nefret ederdim hala görünce uyuz oluyorum.
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    bedduaların gerçek olduğuna inanan kafa ancak trabzondan çıkar zaten. amcık ağızlı aptallar sizi :d
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  109413992
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    akıllara 2009 yılında <a class="b" href="/?q=istiklal+caddesi">istiklal caddesi</a>'nde üzerine <a class="b" href="/?q=fita%c5%9f">fitaş</a>'ın dev camı <a rel="nofollow noopener" class="url" target="_blank" href="https://www.hurriyet.com.tr/gundem/istiklal-caddesi-nde-kafalarina-cam-dustu-10837250" title="https://www.hurriyet.com.tr/gundem/istiklal-caddesi-nde-kafalarina-cam-dustu-10837250">düşen</a> kızı getirmiştir.<br/><br/>bu ülkede her an tetikte olmalısınız.
  entry_channels: haber
- entry_name: |
    bira içmelik arkadaş veritabanı
  entry_id:  109439040
  entry_writer: khanyon
  entry_fav_count: 1
  entry_content: |
    taksim tünelde pırıl pırıl bir ortamda ikinci biramı söyledim. eskici pera bar diye bi yerde, açık havadayım. yolu düşen olursa selam versin :) serin, insan az, belli belirsiz müzik sesi geliyor. öyle keyifli geldi ki nasıl anlatacağımı şaşırdım.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ben parmağımla gösterip "şu" diyorum.<br/>+ bir de şuna bakabilirmiyim??
  entry_channels: teknoloji
- entry_name: |
    counter-strike global offensive
  entry_id:  109420595
  entry_writer: einstein ona arkadasim diyor
  entry_fav_count: 0
  entry_content: |
    küfür etmeyi hiç sevmem bilen bilir ama <a class="b" href="/?q=orospu+%c3%a7ocuklar%c4%b1">orospu çocukları</a>nın yaptıkları bu hile olayı yüzünden oyundan soğudum. oyunun da çok da sikindeydi. sadece belirtmek istedim.<br/><br/>t: yıllardır oynadığımızdı.
  entry_channels: oyun
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ne gun 1000'in altina inecegimiz belli oldu gencler, sen cok yasa bakanim.
  entry_channels: siyaset,sağlık,haber
---
