...
- entry_name: |
  ...
  entry_fav_count: 128
  entry_content: |
    ezaaaanlaar dinmeyeceeek!!!!!<br/><br/>bayraaaaaaaakkk inmeyeceeeekk!!!!
...
- entry_name: |
  ...
  entry_fav_count: 70
  entry_content: |
    tam olarak olmayan kapaktır. <br/>çünkü kanımca arka planda şu şekilde bir konuşma gerçekleşmiştir:<br/><br/>-hey netflix twiti direkt atma bak aklıma bişey geldi<br/>+heyy cem nedir o adamım whatsap?<br/>- bak şimdi önce ben size laf atacağım sonra ona cevap olarak benim filmin tanıtımını yapacaksınız. biraz birbirimize çakmış olacağız ama günün sonunda herkes bu olayı konuşuyor olacak.<br/>+ içinde lgbt yok ama yine güzel fikir lets do dis
  entry_channels: sinema,magazin
- entry_name: |
    yks 2020
  entry_id:  109413224
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    en güzeli hiç anlatmamaktır<br/>şayet anlatılmak istediğiniz bir anınız varsa eski sevgilim yerine 'bir arkadaş' kelimesini kullanmak ilişki için daha faydalı olur<br/><br/>kimse eski sevgiliyi dinlemekten hoşlanmaz
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    cevabını bulamadığım sorunsal.<br/><br/>bildiğim kadarıyla sabit maaşı yok, <br/><br/>devlette çalışmıyor, <br/>özelde çalışmıyor, <br/>ikramiye usulü çalışmıyor, <br/>tam işi bitiriyor, teşekkür edip belki bir plaket, belki üç beş kuruş bir cep harçlığı verecekler, daha şerifin cümlesi bitmeden arazi oluyor.<br/><br/>kısacası, elde yok, avuçta yok, bu red kit ne ayak?!
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    sinir bozucudur. <br/><br/>almanın yanı sıra aldırma manyaklığı da var. mesela evleniyorsun, hemen başlıyorlar “ev almayı düşünüyor musunuz” “ee araba alacak mısınız?” düşünmüyoruz, o parayla gezmek istiyoruz diyince de analarına sövmüşüz gibi triplere giriyorlar.
  entry_channels: anket,ekonomi
- entry_name: |
    burcu esmersoy'un bir üründen 25 bin tl kazanması
  entry_id:  109442563
  entry_writer: sennediyonlan
  entry_fav_count: 17
  entry_content: |
    başlığın doğrusu “burcu esmersoy’un bir ürün tanıtımından 25 bin tl kazanması” olacaktı.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/kadrajmagazin/status/1276844344046235648?s=21" title="https://twitter.com/kadrajmagazin/status/1276844344046235648?s=21">link</a><br/><br/>okumanın harbi para kazanmaya faydası yok bu ülkede
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    he amk ankaragücü maçı satmış gibi oynuyor. normalde barcelona gibi oynadıkları için şu ana kadar 24 puan toplayıp dandik ligimizin dibine demir atmış durumdalar zaten. <br/><br/>tanıım: trabzonspor’un oyunun hakimi olarak 1-0 önde götürdüğü maç.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    12000 tl maaş + 165 cm boy + renkli göz + 14 cm
  entry_id:  109449774
  entry_writer: frondie
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=piknik+t%c3%bcp%c3%bc">piknik tüpü</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  109448328
  entry_writer: console writeline
  entry_fav_count: 1
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    şimdiden söylüyorum,<br/>ölünce "iyi ki geberdi gitti pislik herifin tekiydi" diyecem.<br/><br/>sonra gelip de bana "ölünün arkasından rörörö" demeyin, ağzınıza tuvalet terliğiyle vururum.<br/><br/>ölü var, ölü var.<br/><br/>tanım: tuvalet terliği kadar değeri olmayan pis omurgasız kişi.
  entry_channels: siyaset,haber
- entry_name: |
    itümahremiyetistiyor
  entry_id:  109450297
  entry_writer: abocant
  entry_fav_count: 1
  entry_content: |
    itü bir çiftliktir.<br/>itü rektörü <a class="b" href="/?q=k%c3%b6t%c3%bc">kötü</a> bir çobandır.<br/>itü bir çiftliktir.<br/>itü bir çiftliktir.<br/>itü bir çiftliktir.<br/>türkiye’de çocuğumun kapısından dahi girmesini istemeyeceğim tek okul itüdür. <br/>öğrenciler isteğinde sonuna kadar haklıdır . hele ki diğer üniversite emsalleri varken bu olay saçmalığın daniskasıdır.<br/>ama üzüldüğüm tek nokta şudur ki bu olay beni gram şaşırtmamıştır.<br/>unutmadan ; itü bir çiftliktir.
  entry_channels: haber,eğitim
- entry_name: |
    ali şansalan
  entry_id:  109447222
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    şaomi'dir. 'y' harfi nasıl geliyor onu anlamadım
