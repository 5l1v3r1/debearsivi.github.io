...
- entry_name: |
    müslümanlara sorulacak tek soru
  entry_id:  109888439
  entry_writer: larutanrepus
  entry_fav_count: 12
  entry_content: |
    bize ne sorarsanız sorun aldığınız hiç bir yanıta inanmadığınız gibi alaya alacaksınız. diğer dinlere saygıda kusur etmez ama söz konusu islam olunca düşmanlıkla salyalarınız akar. cevabını öğrenmek istemediğiniz şeyleri sormayın.
  entry_channels: anket
- entry_name: |
    7 temmuz 2020 başakşehir denizlispor maçı
  entry_id:  109884723
  entry_writer: toolga61
  entry_fav_count: 8
  entry_content: |
    maçı izleyen trabzonspor taraftarının başakşehir taraftarından daha fazla olacağı maç.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  109865679
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/entry/11244530">#11244530</a>)<br/><br/>attım gitti.. muhtemelen içim temiz olduğu için, güzel bir şey çıkacak.. anlamlı..
  entry_channels: anket,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    tadım yok reisler. pek bi derdim de yok ama bir şeyler birikti de bunaldım herhalde.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yalova sahilde üç erkek arkadaş içiyoruz. birasını alan gelebilir.
