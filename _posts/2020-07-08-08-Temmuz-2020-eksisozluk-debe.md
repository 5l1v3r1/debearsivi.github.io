---
layout: post
title: 08 Temmuz 2020 Ekşi Sözlük Debe
data:
- entry_name: |
...
- entry_name: |
    7 temmuz 2020 youtube yasaklarının başlaması
  entry_id:  109869555
  entry_writer: absorbe
  entry_fav_count: 840
  entry_content: |
    a haberle dalga geçmek 7 cihanda yanma sebebidir çünkü.<br/><br/>böyle kutsal bir haber ağıyla dalga geçmek sizin neyinize?<br/><br/>kararı destekliyorum. kılışdar da kaka zaten.
...
- entry_name: |
  ...
  entry_fav_count: 286
  entry_content: |
    ingilizce konuşulan ülkeler türkiye'ye turkey demekten vazgeçtikleri anda yapılabilir.
...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    wasteland kelimesine türkçe karşılık önerileri
  entry_id:  109862287
  entry_writer: worenn
  entry_fav_count: 81
  entry_content: |
    harapdiyar.<br/><br/>ama komikli olsun dersen yıkıkkent, bitikhisar da olur. yıkık, bitik çünkü falan.
  entry_channels: anket,teknoloji
- entry_name: |
    keriz silkeleme odaklı geliştirilmiş şeyler
  entry_id:  109854840
  entry_writer: ursmeier
  entry_fav_count: 72
  entry_content: |
    maaşsız satış elemanı olarak kadınları kullanan bilumum makyaj ve temizlik firmalarının üye zinciri sistemi.<br/><br/>bir de lol bebek denilen dünyanın en absürt oyuncağı. parmağım kadar oyuncak bebeklerin fiyatı 140 tl ve pokémon topu gibi bir ambalajda satılıyor. topun içinden ne çıkacağını da bilmiyorsun. farklı aksesuarlarda veya renklerde bebekler çıkabiliyor. bazen bebek de çıkmıyor parmağım kadar bebeğin tırnağım kadar giysisi falan çıkıyor, tamamen sürpriz. çocuklar ve anneler çılgınlar gibi alıyor bunlardan. bu siksikinin bu fiyata satılabileceğini tahmin edip üreten girişimciyle karşılaşırsam muhakkak ellerinden öpeceğim.
...
- entry_name: |
  ...
  entry_fav_count: 70
  entry_content: |
    anlik dusunup konusmaktan o kadar korkuyor ki, kendine bagli genclik kollariyla yaptigi <a class="b" href="/?q=26+haziran+2020+erdo%c4%9fan%27%c4%b1n+youtube+canl%c4%b1+yay%c4%b1n%c4%b1">26 haziran 2020 erdoğan'ın youtube canlı yayını</a>nda bile kolpadan sorulara makale gibi hazirlanmis kocaman yazilari robot gibi tekduze bir sekilde okuyarak gecti. daha dogrusu "miribi biskinim, ben oss'ye hazirlaniyorum ama ... blabla ertelendi ama ... blablabla ... yine tarihi degisti. nedenini ogrenebilir miyiz?" diye sacma sapan bir 'konu basligi' acip, inanilmaz uyku getirici bir ses tonuyla yarim saat nesir okumasi yapti.<br/><br/>ozguveni sifir. en ufak seylerden bile inanilmaz çekiniyor. sosyal medya konusunda bir iki sacma denemeleri oldu, onu da ellerine yuzlerine bulastirinca simdi bazi seyleri bahane edip her seyi kapatmaya calisacak. adama demezler mi madem o kadar hassastin, bu sosyal medya hdp'ye, chp'ye sallarken; meral aksener'e cirkin iftiralar atilirken neredeydin? yani ozguvenden kastim, kaybetmekten o kadar cok korkuyor ki inanilmaz sacma seyleri (sosyal medyaya komple savas acmak gibi) hemen devreye almaya calisiyor, gundeme tasiyor.<br/><br/>tabii su da var ki, bunlari yaparken gundemi degistiriyor aslinda. ayasofya ve kurtaj tartismalari mesela, 3-4 sene arayla donusumlu olarak surekli ortaya atiliyor. ancak ekonomi ve giden ankara/istanbul belediyeleri ile dengesi cok bozuldu. yuzunde cok garip bir hava var.<br/><br/>bunlari "gidecek" anlamina geliyor diye yazmiyorum. sadece boyle bir halet-i ruhiyede gibi geliyor bana. su an mesela tv'ye cikip (atiyorum) kilicdaroglu ile karsilikli bir kapismaya girecegine haftalarca sarayindan cikmamayi tercih eder. onunde yazili bir metin olmadan tek bir soruya bile cevap veremez.<br/><br/>o derece bitik aslinda tek basina.
...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    7 temmuz 2020 akpınar ve gezen'e hakaret davası
  entry_id:  109881534
  entry_writer: dolaptaki yildiz tornavida
  entry_fav_count: 36
  entry_content: |
    bizim semt aftan çıkan torbacılarla, müptezellerle, adam yaralama sabıkası olanlarla doldu. karşıt görüşten olanları tıkmak için yer lazımmış demek.
...
- entry_name: |
  ...
  entry_fav_count: 34
  entry_content: |
    kazanıp ligde 3. olarak şampiyonlar ligine kalalım da 5. ön elemede adı sanı duyulmadık bir doğu avrupa takımına iki maçta da yenilerek elenip avrupa ligi ön elemesine kalalım dimi?<br/><br/>tanım : bir maç.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    hakan hepcan'ın sözlük yazarlarına küfretmesi
  entry_id:  109854920
  entry_writer: kendine bile muhalif adam
  entry_fav_count: 10
  entry_content: |
    bu arkadaşın hayattaki tek başarısı norveçli bi kız bulup onunla evlenerek norveç'e taşınması değil mi? bunun için mi tebrik edeceğiz ?
  entry_channels: ekşi-sözlük,magazin
- entry_name: |
    ideal yaşam için gerekli olan aylık gelir
  entry_id:  109884301
  entry_writer: boylamdevlet
  entry_fav_count: 9
  entry_content: |
    (bkz: <a class="b" href="/?q=entry+nick+uyumu">entry nick uyumu</a>)<br/>15.000 tl türkiye için gayet yeterlidir.<br/>ek: hemen toplanmışlar 10-15.000 tl paramı lancılar.farklı ülkelerde mi yaşıyoruz anlamıyorum ki ?
  entry_channels: ekonomi
- entry_name: |
    rastgele entry numarası yazmak
  entry_id:  109883087
  entry_writer: oknnkacmaz
  entry_fav_count: 8
  entry_content: |
    <a class="b" href="/entry/31313131">#31313131</a>
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    rte süper kahraman olsa hangisi olurdu sorunsalı
  entry_id:  109885244
  entry_writer: sonnenuntergang
  entry_fav_count: 7
  entry_content: |
    (bkz: <a class="b" href="/?q=gazman">gazman</a>)<br/><br/>edit: gerçi o sadece osuruyordu.. kendisi her daim ağzımıza sıçmaktadır..
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    yerinizi alın gün döndü. abazalar yardırın.<br/><br/>edit: oha istanbulun fethi gibi. aletleri karadan çıkarıyorlar.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    utangaç kadın çekiciliği
  entry_id:  109878154
  entry_writer: dekinededi
  entry_fav_count: 3
  entry_content: |
    utangacın içerisindeki utanmazı çıkartabilme ihtimalidir çekici olan ya da utanmaz görüneni utandırabilmektir. <br/>çünkü insan, karşısındaki kişinin, varlığından habersiz olduğu, hiç alışık olmadığı duygu durumunun sebebi olduğunda, onun için özel olduğunu hisseder.<br/>“seninleyken kendimi tanıyamıyorum” cümlesi söyleyene de söyletene de iyi gelir. <br/>en kontrolsüz, en hesapsız, en saf hâldir. en yalın hâl de, çoğu zaman üç harflinin habercisidir. aşk... ve aşk insanı fena çarpar :))
  entry_channels: ilişkiler
- entry_name: |
    emre belözoğlu
  entry_id:  109886074
  ...
  entry_fav_count: 2
  entry_content: |
    türk futbol tarihinin en büyük futbolcusudur.
  entry_channels: spor
- entry_name: |
    fernando alonso
  entry_id:  109883892
  ...
  entry_fav_count: 1
  entry_content: |
    konvoy yapmak isteyen boğa heykelinin önüne gelsin arkadaşlar. f1'e revive attılar.<br/><br/>schumacher'den sonra yaşayan en yetenekli pilot.
  entry_channels: spor,otomotiv
- entry_name: |
    atak helikopterinden gerçek 3d operasyon görüntüsü
  entry_id:  109880358
  entry_writer: ilgeru
  entry_fav_count: 1
  entry_content: |
    görüntü güzel ama teröristleri göreydik iyiydi. böyle dağı taşı bombalıyormuşuz gibi algı oluşuyor. 360 kamera yerine iyi bir zoom kamerayla teröristin donunu bile görüntülersin. bu teröristlerin itlaf edilme anı net görüntülerle kayıt altına alınmadıkça tatbikat tadında operasyon görüntüleri yayınlamış oluruz ancak.
  entry_channels: teknoloji,havacılık
- entry_name: |
    komşuları itici yapan detaylar
  entry_id:  109884263
  entry_writer: sikicitroll
  entry_fav_count: 0
  entry_content: |
    eve kız attığını bildiği için sana uyuz olması. <br/><br/>asla benim siktiğim kızları sikemeyeceksin amına kodumun çomarı seni.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=am+yeterli+garda%c5%9f">am yeterli gardaş</a>)
  entry_channels: ilişkiler
- entry_name: |
