...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    10 yıldır evli olup çocuk yapmayan insan
  entry_id:  108888958
  entry_writer: mortingenstryze
  entry_fav_count: 77
  entry_content: |
    evliliği çocuk yapmaya endekslemiş yazar sicmiği. belki çocukları olmuyor sanane lan.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    ülkeyi kuran jenerasyondur. 1860 ve 1900 yılları arasında doğdukları söylenebilir. maalesef, acıyla yoğurulmuş kişiliklere sahiptirler. umarım hiçbir jenerasyon onlar kadar kaliteli olmak zorunda kalmaz. <br/><br/>"birinci cihan harbini gören genç de olsa yaşlıdır." derler.
  entry_channels: anket,tarih,eğitim
- entry_name: |
    evlenme-boşanma işleminin e-devlet'ten yapılması
  entry_id:  108902128
  entry_writer: jack in od kesesi ya da kirik kalbi
  entry_fav_count: 17
  entry_content: |
    çocuğu da aile ve sosyal politikalar bakanlığı'nın sitesinden zip halinde indirirler artık. <br/><br/>tanım: hayaldir
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    3. sezon başlamadan ne bok yapacağınızın kimseyi ilgilendirmediği dizi. inanabiliyor musunuz? kimsenin umurunda değil. kimsenin.
...
- entry_name: |
  ...
  entry_channels: anket,yeme-içme
- entry_name: |
    güneşe tapmak vs aya tapmak
  entry_id:  108901747
  entry_writer: naneli sakiz
  entry_fav_count: 0
  entry_content: |
    en çok takipçisi olan iki dinin arasındaki gerilimin temel nedeni olan karşılaştırma. 1500 senelik tartışmanın sıfır noktası.
  entry_channels: anket
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  108903212
  entry_writer: uzunbirbirey
  entry_fav_count: 0
  entry_content: |
    erkeğim 23 yaş 178 boy kıvırcık saç buğday tenliyim istanbuldan güzel ve sevgili arayan kadınları beklerim.<br/>(bkz: <a class="b" href="/?q=kral+tv">kral tv</a>)<br/>(bkz: <a class="b" href="/?q=arabeskfm">arabeskfm</a>)<br/>(bkz: <a class="b" href="/?q=kemal+sunal">kemal sunal</a>) (bkz: <a class="b" href="/?q=yaln%c4%b1z+kalpler">yalnız kalpler</a>)<br/>şaka mısınız amk.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
