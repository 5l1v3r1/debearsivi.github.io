...
- entry_name: |
    başörtüsüz girdiğim sınavda başörtülü gözetmenim
  entry_id:  109468624
...
- entry_name: |
  ...
  entry_fav_count: 102
  entry_content: |
    öncelikle rejim değişirdi,demokrasi zayıflardı , muhalif gazeteciler tutuklanır bazı siyasiler hapse atılırdı.bazı kimseleri sorgulamak eleştirmek suç haline gelirdi.<br/>dolaylı olarak ekonomi kötüye giderdi.<br/><br/>bi dakika ya...
...
- entry_name: |
  ...
  entry_fav_count: 64
  entry_content: |
    bunlar lgbt normalleştiği zaman kendileri de zorla gay olacak zannediyorlar. bakın espri olsun diye yazmıyorum bu insanlar böyle.<br/><br/>edit: <a rel="nofollow noopener" class="url" target="_blank" href="https://hizliresim.com/2KosXR" title="https://hizliresim.com/2KosXR">bakınız...</a>
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    az su içerek yağ yakımını hızlandırmak
  entry_id:  109493556
  entry_writer: garip bir koleksiyoncu
  entry_fav_count: 58
  entry_content: |
    az su içerek yağınız da vücutta kalır böbrekleri de kucağınıza alırsınız.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    11 yıllık vestel tv'nin içinde lg lcd ekran olması
  entry_id:  109480422
...
- entry_name: |
    çocukluktaki ikonik logo
  entry_id:  109493469
  entry_writer: henri charriere
  entry_fav_count: 43
  entry_content: |
    türkiye cumhuriyeti’nin kuruluşunun yetmiş beşinci yılı için özel yapılmış logo veya bayrak.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    almanya'nın vatandaşlarına tahliye ücreti ödetmesi
  entry_id:  109494400
  entry_writer: don emilio
  entry_fav_count: 32
  entry_content: |
    keşke almanya’ya tahliye olsam da parası neyse versem dediğim başlık.
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    efendilik isteyen yunanistan'a gitsin! burada sikis var, sikis!
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    fizik profesörünün falcıya 100 bin tl kaptırması
  entry_id:  109476263
  entry_writer: kargakargagaakdedi
  entry_fav_count: 9
  entry_content: |
    çok zor bir dönemden geçtiği varsayımı ile büyüye inanması meşrulaştıran bilim insanı. çok zor dönemden geçen bir bilim insanı yardıma ve desteğe ihtiyaç duyduğunda, üfürükçüye, hacıya, hocaya değil, kendisine destek verecek düzgün bir psikiyatrist ve psikologa gider. onu da detaylıca araştırır, psikiyatrist ise terapi üzerine eğitim ve sertifikaları var mı, psikolog ise klinik psikoloji üzerine yüksek lisansı var mı diye?<br/><br/>valla ne işi var büyüye, üfürüğe, cine, periye, astrolojiye inanan insanların akademide? 'diktatör olsa yapılacak küçük şımarıklıklar' başlığı var ya, hah ben diktatör olsam din de dahil metafizik herhangi bir öğeye inanan, evrimin en az yerçekimi teorisi kadar ispatlanmış bir teori olduğunu kabul etmeyen birini, akademinin kapısından bile sokmazdım. bu dolandırılan kaçıncı prof ya? biraz gündemi takip edin ve rasyonel düşünceden uzak kalmayın. hocanın eleştirilmesi ve yerilmesi çok haklı, başkalarına örnek olur belki.<br/><br/>bu arada erkek cephesini yakından tanımıyorum ama şu tarikat şeyhlerinin çoraplarını koklayan, analarını, bacılarını, eşlerini şeyhlerine ödül olarak sunan kısmı dolayısıyla onlar da daha çok metafizik inançlar böyle işliyor sanırım. ismail saymaz bunu kitabında güzel açıklamıştı zaten. ama şu evlenme ile kafayı bozmuş bazı hemcinlerim de artık bana 'ehhh! ' dedirtiyor. pek çoğunda batıl inanç yaygınlığı görülüyor ve bu inançtan dolayı da kafayı çizmiş durumdalar. mesela biri var, evlenmemesini, arabasının bozulmasını, belinin ağrımasını ve hatta bardağının kırılmasını, kısaca otu boku her şeyi nazara bağlıyor. üstelik bazen olayın rasyonel gerekçesini de biliyor bu nazarcı tayfa. önce diyor ki, 'annemlerin orada çok ağır işler yaptım, soğukta da kaldım ondan belim ağrıyor.' peşine 'geçen olimpos fotolarını koydum facebook'a, gören aradı, herkes çok kıskandı, nazardan belim ağrıyor.' diyor. <br/><br/>tüm bu nazarcı, falcı, büyücü, tarikatçı, astrolojici tayfa benden uzak, kendi tanrılarına yakın olsun. bilimsel düşüncenin en temel adımını geçememiş bir insan da, öğrencinin ufkuna zerre katkı sağlamaz, olsa olsa robot gibi bir şeyler anlatıp çıkar.
  entry_channels: haber
- entry_name: |
    28 haziran 2020 covid-19 vakasının 197239 olması
  entry_id:  109493907
  entry_writer: tskitishvili
  entry_fav_count: 9
  entry_content: |
    beyefendi okumus, doktor, ustelik bakan, onlarca danismani var. <br/><br/>buna ragmen rakamlari sanki dolar dune gore %1 azaldi tarzi piyasalardan haber veren muhabir gibi sunuyor.<br/><br/>bu is boyle bir sey degil, dune gore 16 kisi azalmasinin istatistiksel olarak hic bir anlami yok diyen bir kisi de yok mu? <br/><br/>politik davraniyor, manipulasyon yapiyor desen o daha da sacma.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    ağırlıklı olarak studio ghibli filmlerini izlerken yaşadığım bir durum benim. en çok da ateşböceklerinin mezarı filmini izlerken ağlamıştım. 2 gün geçmedi üzüntüm. kendi kendime yas tuttum. bu film çok başka. çok dokunaklı. hatırlayınca bile içim sızlıyor.<br/><br/>(bkz: <a class="b" href="/?q=hotaru+no+haka">hotaru no haka</a>)
  entry_channels: tv,sanat,sinema
- entry_name: |
    ömer bayram
  entry_id:  109492400
  entry_writer: bitlicoin
  entry_fav_count: 4
  entry_content: |
    sabri ruhunu yaşatmaktadır. orta yapayım derken kapaklanması bu konudaki yeteneğini ispatlamaktadır.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  109462456
...
- entry_name: |
    bir yağ yakma önerisi bırak
  entry_id:  109490717
  entry_writer: annunakiyim
  entry_fav_count: 1
  entry_content: |
    o çok istenen ama bir türlü gelmeyen haberi, ısrarla beklemeye devam etmek.
  entry_channels: spor,anket,bilim
- entry_name: |
...
- entry_name: |
    aleyna tilki'nin reklamdan 1.5m tl'den çok alması
  entry_id:  109495805
  entry_writer: post tenebras lux
  entry_fav_count: 0
  entry_content: |
    az bile almış. bu dondurmanın git cirolarına bak. sana suyu dondurup satıyorlar.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://gidadedektifi.com/tag/algida/">https://gidadedektifi.com/tag/algida/</a>
  entry_channels: magazin
---
