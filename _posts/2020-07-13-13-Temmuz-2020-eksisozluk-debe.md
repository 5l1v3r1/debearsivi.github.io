...
- entry_name: |
  ...
  entry_fav_count: 188
  entry_content: |
    bir özel okul öğretmeni olarak oyumu devlet okulundan yana kullanıyorum. fakat günümüz devlet okullarından değil, bizim zamanımızda okuduğumuz eğitim eşitliğinin, görece biraz daha adil olduğu dönemlerin devlet okulu. o zamanlar zengin de fakir de aynı okula gider aynı eğitimi alırdı. öğretmenler işini daha bir severek yapardı. ve okul denetimleri çok daha sıkı olduğu için eğitim buna bağlı olarak biraz daha kaliteliydi. fakat şu an devletteki öğretmenler o kadar rahat bırakılmış ve denetimden o kadar yoksunlar ki anlatamam. <br/><br/>peki özelde işler nasıl yürüyor? tek cümle ile özetliyorum; özelin allah belasını versin!<br/><br/>not: final okulları, doğa, bahçeşehir gibi okullardan bahsediyorum. alın size isim gibi isim. öyle fabrikadan bozma hiç bir şubesi olmayan özel okullarda da çalıştım fakat asıl kastettiğim süslü yazıları olan türkiyenin dört bir yanında şube açmış çocuklarınızı sermaye olarak gören kurumlar.<br/><br/>istisnalar hariç, 2014 yılındaki yasa değişikliğinden bu yana özelde öğretmenlerin çoğu asgari ücretle çalıştırıldı. özelde haftada 30 saat derse girmeyen (haftasonu hariç!) zaten yok! hele ki benim gibi ingilizceciyseniz! soruyorum size bu ortamda yıllık en az 20 bin tl verilen bir kurumda çocuklarınıza gerçekten verimli bir eğitimin verilebileceğini düşünüyo musunuz? ne özel eski özel, ne devlet eski devlet. fakat paranızı bu eğitim tüccarlarına kaptırdıkça bu düzen asla değişmez. özelin hiç bir savunulacak tarafı yok nokta.
...
- entry_name: |
    bir kadının atatürk'e düşman olmasının sebebi
  entry_id:  110093040
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    herifler uyduruktan cizdikleri ofsayt cizgisiyle fener'e golu yedirdiler, o kadar utanmaz adamlar ki milisaniyelik gosterdikleri ilk ofsayt cizgisi islerine gelmeyince hemen ekrani kapatip 5 dakika sonra yenisini cekip yutturmaya calistilar. <br/><br/>hangi takim nasil dayanacak kardesim bu duzene? besiktas maci haric her macta ayri ayri bictiler, ya golumuzu yediler ya gol yedirdiler. millet kadro, teknik direktor derdinde ama bu tff varken gunumuz liverpool'unu getirsen ilk 3'e giremez bu ligde. <br/><br/>tff, mhk, derin galatasaray'in arka bahcesi kim varsa istifa. futbol kokten temizlenmedigi surece turk futbolu batmaya mahkum.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    maçın seyircisiz olması uyku sorunu olan insanları televizyon başına kitleyecektir.
  entry_channels: spor
- entry_name: |
    kırmızı ruj
  entry_id:  110104902
  entry_writer: herasta
  entry_fav_count: 3
  entry_content: |
    bir süre sonra dudağın biraz iç tarafındaki ten rengi göze batmaya başlayan rujdur rengidir. henüz tam olarak dudağa entegre olanını yapamadılar.<br/><br/>bir de ağır göz makyajıyla kullanılmaması tavsiye olunur. <br/><br/>sıklıkla kullanılamaması gerekiyor, kırmızının bir yeri olmalı insan hayatında. karakterize bir renk ve sürekli göz önünde olmaması lazım , bence yani.
  entry_channels: moda
- entry_name: |
    işsizlik düşerken çalışan sayısının azalması
  entry_id:  110105690
  entry_writer: jedilost
  entry_fav_count: 3
  entry_content: |
    aslında gayet basit bir açıklaması olan durumdur: hepsi ölmüş demek ki.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    pandemi sonrasi hic bir maci kazanamamis takim. youtube'da yemek videosu mu izlediniz paso amk.
...
- entry_name: |
  ...
  entry_id:  110109080
  entry_writer: prosesyap
  entry_fav_count: 0
  entry_content: |
    balkon bira şehrin gürültüsü
