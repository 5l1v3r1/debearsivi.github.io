---
layout: post
title: 04 Temmuz 2020 Ekşi Sözlük Debe
data:
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 163
  entry_content: |
    (bkz: <a class="b" href="/?q=matemati%c4%9fim+k%c3%b6t%c3%bc+matematik+yasaklans%c4%b1n">matematiğim kötü matematik yasaklansın</a>)
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    0.9 ile onlar da uç mu dediğim versustur. hem uç isteyen olmazdı hem de kütük gibi olduğu için istemsiz bastıran şahsımca kırılmazdı. <br/>şimdi de portminle kağıt karalıyorum
...
- entry_name: |
    bulgaristan'ın türkiye'den zengin olması
  entry_id:  109711805
  entry_writer: tek jetonla oyun bitiren cocuk
  entry_fav_count: 17
  entry_content: |
    <a class="b" href="/?q=t%c3%bcrkiye%27den+gelen+cevaps%c4%b1z+%c3%a7a%c4%9fr%c4%b1">türkiye'den gelen cevapsız çağrı</a> dönemini başlatacaktır.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    koymadılar şu derdini sikeyim butonunu...
  entry_channels: anket
- entry_name: |
    mabel matiz
  entry_id:  109715953
...
- entry_name: |
    soda şişesinin yeşil olma sebebi
  entry_id:  109721370
  entry_writer: ben smyrna
  entry_fav_count: 5
  entry_content: |
    soru başlığa cevap entry girmek çaylak hatta uçma sebebi idi.<br/>adam bunu da aşıp zaten sözlükte olan bir konuyu soru şeklinde başlık açıp ilk entryde yine soru sormuş. tebrikler. 60 entryli adamdan da bundan fazlası beklenmez. <br/>(bkz: <a class="b" href="/?q=soda+%c5%9fi%c5%9fesi">soda şişesi</a>)
  entry_channels: bilim,sağlık
- entry_name: |
    kadınlar da evlenme teklif etsin kampanyası
  entry_id:  109718486
  entry_writer: mudavim5824
  entry_fav_count: 5
  entry_content: |
    normalde (bkz: <a class="b" href="/?q=evlenme+teklif+etme+sekilleri">evlenme teklif etme sekilleri</a>) başlığına yazacaktım ama aklıma bu başlık geldi.<br/><br/>beyler bu bir devrim değil reformdur. yine aynı şekilde evlenme teklifimizi ediyoruz ancak<br/>olay şu şekilde gerçekleşiyor:<br/>-benimle evlenir misin?<br/>+evet (kalpli gözler manitanız)<br/>-...<br/>+ne oldu neden sustun sevinmedin mi?<br/>- senin de etmeni bekliyorum<br/>+nasıl yani?<br/>-ben senle evlenmek istiyorum, her şey tamam ok da sen benle evlenmek istiyor musun? sen de bana sor bakalım.<br/><br/>şeklinde karşılıklı evlenme teklifiyle, müşterek hayata başlamanın adımını atıyoruz.<br/><br/>edit: çünkü evlenmek bir işteş fiil değildir. mesela iki kişi karşılıklı diyalog kurar, kon-uş-mak dersiniz, sevişirsiniz sev-iş-mek fiili karşılık bulur ama evlenme teklifine neden evleşmek demiyoruz? en az iki kişi arasında yapılan eylemler işteş fiil ise "evleşmek" denmesi gerekmez miydi?
  entry_channels: ilişkiler
- entry_name: |
    denizlispor
  entry_id:  109721648
  ...
  entry_fav_count: 4
  entry_content: |
    takımın başına pavyoncu kılıklı <a class="b" href="/?q=b%c3%bclent+uygun">bülent uygun</a>’u getirerek dibe çöküşü x2 hızına çıkartan ege takımı.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    oğlum siz sikecek birilerini arıyorsunuz bırakın şimdi bira ayaklarını. madem bira içecek arkadaş aranıyor sadece bugün 2 sayfa entry var. toplanın işte yazanlar olarak için biranızı hınzırlar.
...
- entry_name: |
    sosa'nın eşinin napaysın dövmesi
  entry_id:  109721154
  entry_writer: rasputitsa
  entry_fav_count: 1
  entry_content: |
    sosa'nın eşini dövmesi diye okudum bu aralar malum sürekli görüyoruz.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    dert babalarıyla dolmuş yine buralar
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=wRnkFeywfBE" title="https://www.youtube.com/watch?v=wRnkFeywfBE">foy vance - make ıt rain</a>
...
- entry_name: |
  ...
  entry_id:  109713297
  entry_writer: franzqq
  entry_fav_count: 0
  entry_content: |
    oysa kahve içmişliğimiz de vardı <br/>“bu ne hatır gönül bilmezlik” diyemedim
  entry_channels: anket,sanat,edebiyat
- entry_name: |
    rakı içerken dinlenebilecek en güzel şarkı
  entry_id:  109719532
  entry_writer: cinarovski
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=muazzez+ersoy+-+kahverengi+g%c3%b6zlerin">muazzez ersoy - kahverengi gözlerin</a>
  entry_channels: anket,müzik,yeme-içme
- entry_name: |
    her yazardan 1 film tavsiyesi
  entry_id:  109721187
  entry_writer: smirnoff 98
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=can%c4%b1m+karde%c5%9fim">canım kardeşim</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    insan üstlenmemeye çalışsa da bazen çok fazla sorumlulukla doluyor. <br/>2020 felaketler yılı buna da şükürlerle ama yıpratarak geçiyor. <br/>biraz elimi eteğimi çeksem, kaybolsam, kimse anmasa adımı. <br/>yoruldum.
  entry_channels: anket,ilişkiler,ekşi-sözlük,edebiyat
- entry_name: |
    açılacak tostçu için isim önerileri
  entry_id:  109722050
  entry_writer: dal tanrisi
  entry_fav_count: 0
  entry_content: |
    kadim tostum
