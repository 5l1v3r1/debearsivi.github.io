...
- entry_name: |
  ...
  entry_channels: tarih,sağlık,havacılık,spoiler
- entry_name: |
...
- entry_name: |
    mantıyı ufacık yapmanın mantıklı açıklaması
  entry_id:  107603013
  entry_writer: kymelria
  entry_fav_count: 65
  entry_content: |
    küçük mantı kurnaz işidir. mantı ne kadar küçük olursa içine o kadar az kıyma girer.<br/>kayseri mantısı da küçük oluyordu değil mi? çakal bu kayserililer. mantı diye haşlanmış hamur yediriyorlar.<br/><br/>edit büdüt:<br/>mantı küçükse de içindeki kıyma aynı kalıyor diyenler çıktı. yok öyle bir dünya. herhangi bir şeyi ölçekli bir şekilde küçültürsen yüzeyi karesi ile hacmi ise küpü ile orantılı olarak küçülür (sözelcilerin gözleri yaşlı, ne diyor bu amk diyor) . hamur yüzeydir iç malzeme hacim <sup class="ab"><a title="(bkz: kıps)" href="/?q=k%c4%b1ps" data-query="kıps">*</a></sup><br/>hele ki hamuru inceltiyorsun diyen çıkıyor onlar daha da vahim. duyan da arkasından karınca duası okunan antep baklava yufkası kullanıyorlar sanacak.
...
- entry_name: |
  ...
  entry_fav_count: 30
  entry_content: |
    bunların niyeti belli oldu artık.. <a class="b" href="/?q=reichstag+yang%c4%b1n%c4%b1">reichstag yangını</a> gibi bir şey planlıyorlar. sonra ise tüm muhalefeti pasifize edecekler.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    vizyonunuz genişler. siz ona acırken aslında acınacak durumda olan sizsiniz ve farkında bile değilsiniz. nasılda şüphesiz ve acabasızsınız.
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    (bkz: <a class="b" href="/?q=stepnelik">stepnelik</a>)
  entry_channels: siyaset
- entry_name: |
    ekşi itiraf
  entry_id:  107583196
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    diğer banka <a class="b" href="/?q=atm">atm</a>'lerinden para çekme kampanyasını bitirmişler. <a class="b" href="/?q=denizbank">denizbank</a> ve <a class="b" href="/?q=teb">teb</a> harici bir yerden çekerseniz 2.06 tl komisyon ödemek zorunda kalabilirsiniz.
...
- entry_name: |
    alef (dizi)
  entry_id:  107586403
  entry_writer: gadjodilo
  entry_fav_count: 2
  entry_content: |
    keşke bütün bölümler çıktıktan sonra izleseydim dediğim dizi. yayımlandığı ilk gün birinci ve ikinci bölümünü izleyip baya beğenmiştim. çekimler, kurgu ve konu ilgi çekiciydi ama bölümler ilerledikçe dizi boka sardı. yeri geldi 35 dakikalık bölümle geçiştirdiler yeri geldi bomboş, hiçbir şeyin olmadığı bölümleri izlettirdiler bize. ben dizi film gurusu değilim, o an izlediğimden aldığım zevke bakarım. şimdi gelelim eyyorlamama. <br/><br/>görüntüler, çekimler, konu, imge kullanımı, alt metin şahane. ekip ciddi emek sarf etmiş. gel gelelim bazı bölümler o kadar boş ki insanın canını sıkıyor. bir hafta beklediğime kesinlikle değmeyen 3-4 bölüm vardı. sahne geçişleri bazen çok sert. bazı kısımlarda çat çat geçiyor sahneler, bu baya rahatsız edici. kimi izleyici oyunculukları çok beğenmiş, kimse kusura bakmasın ama oyunculuklar fecaat. beni en çok hayal kırıklığına uğratan isim ise <a class="b" href="/?q=ahmet+m%c3%bcmtaz+taylan">ahmet mümtaz taylan</a>. bir olmamışlık var settar karakterinde, yapay hissettiriyor. bunun yanı sıra<a class="b" href="/?q=kenan+imirzal%c4%b1o%c4%9flu">kenan imirzalıoğlu</a> ve <a class="b" href="/?q=melisa+s%c3%b6zen">melisa sözen</a> de çok donuk oynuyor. yaşar karakteri bir konuyla ilgili açıklama yaptığı kısımlarda sürekli ezberden okuyormuşcasına cansız aktarıyor seyirciye. ercan kesal da bir göründü bir kayboldu. <br/><br/>polisiye, cinayet, katil hikayelerinde katilin kim olduğundan ziyade neden bu suçu işlediği kısmı ilgi çekici olan. bu noktada katil oymuş buymuş tahmini yersiz. ilk iki bölüm çok daha merak uyandırıcıydı. bölümler ilerledikçe sanki fazlaca tekrara düşüldü. sırf 8 bölüme yaymak için olayları uzattılar gibi bir his oluştu bende. bazı karakterlere çok az yer verilmesi de eksi noktalardan biri. settar' ın karısı ilk 3-4 bölüm neredeyse hiç yok. şu zamana kadar toplasan kadının 20 tane repliği yok. altı boş kaldı settar'ın aile hikayesinin sanki. <br/><br/>yarın son bölüm ekrana gelecek. gerçekten merakla bekliyorum konuyu nasıl toparlayıp sonuca bağlayacaklarını. türkiye standartlarının üzerinde çekim tekniğine sahip olduğu su götürmez ama kusursuz, vay be bu da neymiş böyle denilecek kadar muhteşem bir iş mi orası tartışılır işte. sonuç olarak teknik açıdan başarılı ama bir şeylerin eksik kaldığı bir dizi. son bölümüyle fikrimi değiştirebilecek mi bakalım, onu da yarın izleyip göreceğiz.<br/><br/>edit: finali de hayal kırıklığı :(
  entry_channels: tv
- entry_name: |
    geceye bir şarkı bırak
  entry_id:  107584864
  entry_writer: bilmem neden inat ettin
  entry_fav_count: 1
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/Kmiw4FYTg2U" title="https://youtu.be/Kmiw4FYTg2U">while your lips are still red</a>
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    alanya olur o aga, hem her yere uzak hem kendi havalimanı bile var. alanya'dan önce il olan bir yer olursa, alanyalılar isyan çıkartır
  entry_channels: siyaset,anket
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    büyük seviyordur. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup><br/>yerli muzlar küçük oluyor biraz daha çünkü.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    öncelikle ateizmin kendi içinde türleri hatta bireysel varyasyonları vardır. kendi mantık çerçevesinde doğaüstü varlıklara inanmış olabilir.<br/><br/>ayrıca cinler, hayaletler vs. popüler kültür imgeleridir, ateistte olsanız budistte olsanız tv, sinema, sanat üzerinden ciniydi hayaletiydi perisiydi meleğiydi sürekli maruz kalırsınız. kendi faydasına kullanır korku filmi çeker, açıklayamaz cindi der bilmem ne. özünde insanlar hayal güçlerinden korkuyorlar, çok şaşıracak bir şey yok.<br/><br/>deccaldi siccindi evüzübillahdı bilmem ne diye film çekip çekip, üfürükçüyü cinciyi büyücüyü popüler kültür haline getirirsen bırak ateistin cinden korkmasını, cini görür bile.<br/><br/>ha kimisi bu olaylar benim zihnimin bana oyunu stres yaşıyorum o yüzden gördüm der mantıklı davranır, kimisi yeğenini ağaca bağlar, canlı canlı gömer, çocuklarına cinsel istismarda bulunur yaptığı manyaklıklara cinler istedi diye kılıf uydurur etrafındaki gerizekalıları inandırır (bkz: <a class="b" href="/?q=palu+ailesi">palu ailesi</a>)
